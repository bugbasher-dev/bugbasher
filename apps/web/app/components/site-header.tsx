...
export function SiteHeader() {
	...
	return (
		<>
			<header className="bg-muted/50 flex h-(--header-height) shrink-0 items-center gap-2 border-b transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-(--header-height)">
