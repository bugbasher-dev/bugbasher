...
describe('TokenManager', () => {
	...
	describe('storeTokenData', () => {
		it('should store token data successfully', async () => {
			...
			expect(integrationEncryption.encryptTokenData).toHaveBeenCalledWith(
				tokenData,
			)
		...
		it('should handle encryption errors', async () => {
			...
			vi.mocked(integrationEncryption.encryptTokenData).mockRejectedValue(
		...
		it('should handle database errors', async () => {
			...
			vi.mocked(prisma.integration.update).mockRejectedValue(
	...
	describe('getTokenData', () => {
		...
		it('should handle decryption errors', async () => {
			...
			vi.mocked(integrationEncryption.decryptTokenData).mockRejectedValue(
	...
	describe('validateIntegrationToken', () => {
		it('should validate token successfully', async () => {
			...
			const result =
				await tokenManager.validateIntegrationToken('integration-123')
	...
	describe('checkTokensNeedingRefresh', () => {
		...
		it('should handle database errors', async () => {
			vi.mocked(prisma.integration.findMany).mockRejectedValue(
				new Error('Database error'),
			)
